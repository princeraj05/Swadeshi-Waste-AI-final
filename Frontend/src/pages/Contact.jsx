...
export default function Contact() {
  ...
  useEffect(() => {
   ...
   const submit = () => {
    ...
    toast.success("Thank you! We will respond to you via your provided contact.");
    setMessage("");
  };
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            {/* NEW Modern Highlight Box */}
            <div className="mt-5 p-3 rounded-lg bg-green-50 dark:bg-green-900/20 text-sm text-green-700 dark:text-green-300 border border-green-200 dark:border-green-700">
