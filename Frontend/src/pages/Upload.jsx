...
//             <p><strong>Detected Item:</strong> {analysis.id?.item}</p>
//             <p><strong>Material:</strong> {analysis.id?.material}</p>
//             <p><strong>Description:</strong> {analysis.id?.description}</p>

//             <hr className="my-4" />

//             <h4 className="text-xl font-semibold">Eco Analysis</h4>
//             <p><strong>Recyclable:</strong> {analysis.eco?.recyclable ? "Yes" : "No"}</p>
//             <p><strong>Compostable:</strong> {analysis.eco?.compostable ? "Yes" : "No"}</p>
//             <p><strong>Hazardous:</strong> {analysis.eco?.hazardous ? "Yes" : "No"}</p>
//             <p><strong>Decomposition Time:</strong> {analysis.eco?.decomposition_time}</p>

//             <h4 className="text-lg font-semibold mt-4">Steps</h4>
//             <ul className="list-disc ml-5">
//               {analysis.eco?.steps?.map((s, i) => <li key={i}>{s}</li>)}
//             </ul>
//           </div>
//         )}
//       </div>
